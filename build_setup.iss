...
Source: "*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs; Excludes: ".git\*,.github\*,.aider*,TEMP\*,__pycache__\*,logs\*,Output\*,*.iss,*.zip,*.log,src_backup\*,test_*.py,view_*.py,remove_*.py,apply_*.py,bust_*.py,dump_*.py"
