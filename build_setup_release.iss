...
Source: "*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs; Excludes: "runtime\*,*.py,.git\*,.github\*,.aider*,TEMP\*,__pycache__\*,logs\*,Output\*,*.iss,*.zip,*.log"

[Icons]
; Tạo shortcut trong Start Menu
Name: "{group}\Kanezuki"; Filename: "{app}\go-web-release.bat"
Name: "{group}\Gỡ cài đặt Kanezuki"; Filename: "{uninstallexe}"
; Tạo shortcut ngoài Desktop
Name: "{autodesktop}\Kanezuki"; Filename: "{app}\go-web-release.bat"; Tasks: desktopicon

[Run]
; Tự động chạy app sau khi cài đặt xong
Filename: "{app}\go-web-release.bat"; Description: "Khởi động Kanezuki ngay bây giờ"; Flags: nowait postinstall skipifsilent
