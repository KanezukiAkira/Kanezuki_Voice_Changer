...
def main():
    ...
    print("[SUCCESS] Đã mã hóa xong! Các file trong thư mục gốc hiện tại đã được bảo mật.")
    print("[INFO] Mã nguồn gốc chưa mã hóa đã được lưu trữ an toàn trong thư mục 'src_backup/'.")
